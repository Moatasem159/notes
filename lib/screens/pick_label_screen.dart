...
class PickLabelScreen extends StatelessWidget {
  ...
  const PickLabelScreen({super.key, required this.params,this.inNote=false,this.noteStatus=NoteStatus.active});
  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          GetLabelsCubit(sl(), noteStatus: noteStatus,notes: params.notes, labels: params.labels,inNote: inNote)
            ..getLabels(),
